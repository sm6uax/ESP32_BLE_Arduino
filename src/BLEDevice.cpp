 ...
 */
/* STATIC */ BLEClient* BLEDevice::createClient(uint16_t appId=DEFAULT_CLIENT_APP_ID) {
 ...
 */
/* STATIC */ BLEServer* BLEDevice::createServer(uint16_t appId= DEFAULT_SERVER_APP_ID) {
